...
it will grow into a full-featured design system in the future) used in the
Stellar Development Foundation’s web projects. It's meant to be used internally
to keep our web products consistent.
...
- Use the Stellar Design System components "as is", don’t modify existing ones
  to fit your needs if the component doesn’t allow it.
